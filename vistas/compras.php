              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          ...
                          <center> <h1 ><span class="hiddenui"><i class="fas fa-boxes"> Mantenimiento de Compras</i></span></h1> </center>
                          <br>
                            <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-address-book-o "></i> Agregar nueva Compra</button>
