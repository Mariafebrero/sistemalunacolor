<?php 
require_once "../modelos/ValidarPreguntaModelo.php";

$pregunta=new ValidarPregunta();

$pregunta=isset($_POST["idcategoria"])? limpiarCadena($_POST["idcategoria"]):"";
$respuesta=isset($_POST["nombre"])? limpiarCadena($_POST["nombre"]):"";
